...
export const getAllApprovers = async (req: Request, res: Response): Promise<void> => {
  try {
...
export const createApprover = async (req: Request, res: Response): Promise<void> => {
  try {
...
export const updateApprover = async (req: Request, res: Response): Promise<void> => {
  try {
    const { id } = req.params;
    ...
    if (name) approver.name = name;
    if (phone) approver.phone = phone;
    if (position) approver.position = position;
    if (isActive !== undefined) approver.isActive = isActive;
...
export const deleteApprover = async (req: Request, res: Response): Promise<void> => {
  try {
    const { id } = req.params;
